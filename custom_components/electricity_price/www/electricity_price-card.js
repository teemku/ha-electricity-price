...
// ═══════════════════════════════════════════════════════════════════════════════
// ElectricityPriceCard — single-day chart (configurable via editor)
// ═══════════════════════════════════════════════════════════════════════════════
...
class ElectricityPriceCard extends HTMLElement {
  ...
  _render() {
    ...
    const currentColor = currentPrice !== null ? _getColor(currentPrice, thresholds) : 'var(--primary-text-color)';
    ...
    shadow.innerHTML = `
      <style>
        :host { display: block; }
        ha-card { padding: 10px 16px 16px; box-sizing: border-box; }
...
// ═══════════════════════════════════════════════════════════════════════════════
// ElectricityPriceChartCard — tabbed Today / Tomorrow chart (ha-chart-base)
// ═══════════════════════════════════════════════════════════════════════════════
...
// ─── Visual editor: ElectricityPriceCard ────────────────────────────────────
//
...
// ─── Visual editor: ElectricityPriceChartCard ────────────────────────────────
...
window.customCards.push({
  ...
  name: 'Electricity Price Chart (Tabbed)',
  description: 'ENTSO-E day-ahead price chart with Today / Tomorrow tabs',
  preview: false,
});
